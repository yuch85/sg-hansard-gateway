...
fixture (md5 c8605b585f493a6b5e6d936f111c9793) is committed ground truth and
...
def test_404_fingerprint_fixture_survives() -> None:
    ...
    preserves: the fixture must keep its md5 c8605b585f493a6b5e6d936f111c9793.
    """
    ...
    assert digest == "c8605b585f493a6b5e6d936f111c9793"
