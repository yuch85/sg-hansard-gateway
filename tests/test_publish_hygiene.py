...
fixture (md5 db5bd37212a04ab36d3eb130cdc7abfd) is committed ground truth and
...
def test_404_fingerprint_fixture_survives() -> None:
    ...
    preserves: the fixture must keep its md5 db5bd37212a04ab36d3eb130cdc7abfd.
    """
    ...
    assert digest == "db5bd37212a04ab36d3eb130cdc7abfd"
